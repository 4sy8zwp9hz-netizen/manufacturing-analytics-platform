...
This document maps the project's implementation decisions to established software-engineering
concepts.
...
These terms are most useful when tied back to the actual problem and decision. The label “lazy
loading” is less meaningful than explaining why a high-volume dataset was intentionally kept off
the startup path.
